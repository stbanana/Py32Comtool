...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\PY32_PROJECT\BI66_BootLoad_UPP_thread\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\PY32_PROJECT\BI66_BootLoad_UPP_thread\venv\Scripts\deactivate.nu'
